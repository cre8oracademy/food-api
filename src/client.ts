  ...
  constructor(config?: Partial<Configuration>) {
    ...
    this._requestBuilderFactory = createRequestHandlerFactory(
      ...
      [
        ...
        withAuthorization(this._config),
      ],
...
function withErrorHandlers(rb: SdkRequestBuilder) {
  ...
  rb.throwOn(400, ApiError, 'Bad Request');
  rb.throwOn(401, ApiError, 'You are UnAuthorized');
  rb.throwOn(500, ApiError, 'Internal Server Error');
}
...
function withAuthorization({ authorization }: { authorization: string }) {
